...
- 11f1+) [RECOMENDAÇÃO] É recomendado que o Comitê de Regulamentação da WCA seja consultado para verificar se a análise em câmera lenta ou quadro a quadro é necessária.
- 11i1+) [RECOMENDAÇÃO] É recomendado que os competidores que se espera que atendam esses critérios tenham seus embaralhamentos verificados por um segundo embaralhador antes de serem enviados (ver [Orientação 4g+](guidelines:guideline:4g+)).
